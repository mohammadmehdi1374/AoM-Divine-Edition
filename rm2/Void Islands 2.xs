...
void main(void)
{
  ...
  // Text
   ...
   rmAddObjectDefItem(startingGoldID, "Gold mine small", 1, 10.0);
   ...
   if(predatorSpecies<0.5)   
      rmAddObjectDefItem(farPredatorID, "Guanaco", 4, 4.0);
   else
      rmAddObjectDefItem(farPredatorID, "Guanaco", 8, 4.0);
   ...
   if(bonusChance<0.5)   
      ...
      rmAddObjectDefItem(bonusHuntableID, "gazelle", 4, 8.0);
  ...
  /*    rmSetAreaCoherence(id, 0.0); */
   ...
   rmBuildAllAreas();
    ...
    rmPlaceObjectDefInArea(portalID, 0,  rmAreaID("bonus island"+0), cNumberNonGaiaPlayers );
    rmPlaceObjectDefInArea(bonusGoldID, 0,  rmAreaID("bonus island"+0), cNumberNonGaiaPlayers * 2 );
    ...
    for(i=1; <cNumberPlayers)
   {
    ...
    rmPlaceObjectDefInArea(portalID, 0,  rmAreaID("bonus island"+0), cNumberNonGaiaPlayers * 2 );
...
rmPlaceObjectDefPerPlayer(farPredatorID, false);
  ...
  // Text
   ...
   rmPlaceObjectDefAtLoc(rockID2, 0, 0.5, 0.5, 20*cNumberNonGaiaPlayers); 
   ...
   rmPlaceObjectDefAtLoc(ruinsID2, 0, 0.5, 0.5, 5*cNumberNonGaiaPlayers); 
   ...
   rmPlaceObjectDefAtLoc(stagID2, 0, 0.5, 0.5, 10*cNumberNonGaiaPlayers); 
